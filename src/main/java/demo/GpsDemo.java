...
public class GpsDemo {
    ...
    public static void main(String[] args) {
        ...
        List<MatrixWithTime<String>> gpsData = data.getDataByColumn(data.readAsMatrixWithTimeProtectFirstColumn(path,simpleDateFormat,">",3,String.class),"G17",0);
        List<MatrixWithTime<String>> matrix = gpsUtil.calculateCycleSlipMatrix(gpsData,4,2);
        gpsUtil.printCycleSlipAndCountTimes(matrix,2,false);
    }
}
